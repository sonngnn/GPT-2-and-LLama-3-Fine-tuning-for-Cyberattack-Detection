...
#     def mqtt(self):
#         return int(self.src_port == 1883 or self.dst_port == 1883)

#     def coap(self):
#         return int(self.src_port == 5683 or self.dst_port == 5683)

#     def http(self):
#         return int(self.src_port == 80 or self.dst_port == 80)

#     def https(self):
#         return int(self.src_port == 443 or self.dst_port == 443)

#     def dns(self):
#         return int(self.src_port == 53 or self.dst_port == 53)

#     def telnet(self):
#         return int(self.src_port == 23 or self.dst_port == 23)

#     def smtp(self):
#         return int(self.src_port == 25 or self.dst_port == 25)

#     def ssh(self):
#         return int(self.src_port == 22 or self.dst_port == 22)

#     def irc(self):
#         return int(self.src_port == 21 or self.dst_port == 21)
...
#     def tcp(self):
#         return int(isinstance(self.packet, dpkt.tcp.TCP))

#     def udp(self):
#         return int(isinstance(self.packet, dpkt.udp.UDP))
...
#     def dhcp(self):
#         return int((self.src_port == 67 and self.dst_port == 68) or 
#                    (self.src_port == 68 and self.dst_port == 67))
...
#     def LLC(self):
#         try:
#             return int(isinstance(self.packet, dpkt.llc.LLC))
#         except:
#             return 0

#     def MAC(self):
#         if isinstance(self.packet, dpkt.ethernet.Ethernet):
#             return self.packet.src, self.packet.dst
#         return None, None
