...
class ModelEvaluator:
    def __init__(self, base_model_name="meta-llama/Llama-3.2-3B-Instruct", peft_model_path="./checkpoint-5500/"):
        """
...
def main():
    ...
    evaluator = ModelEvaluator(peft_model_path="./checkpoint-5500/")
