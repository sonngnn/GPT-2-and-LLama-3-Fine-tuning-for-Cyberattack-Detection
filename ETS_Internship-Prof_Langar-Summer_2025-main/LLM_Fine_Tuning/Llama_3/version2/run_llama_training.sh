...
# Define project path
PROJECT_PATH="/project/6084087/amomo/LLM-8_features"
...
if [ -d "/project/6084087/amomo/.cache/transformers" ]; then
    cp -r /project/6084087/amomo/.cache/transformers $TEMP_CACHE/
    ...
    echo "[WARNING] No cached models found at /project/6084087/amomo/.cache/transformers"
...
if [ -f "/project/6084087/amomo/.cache/huggingface/token" ]; then
    cp /project/6084087/amomo/.cache/huggingface/token .cache/huggingface/
    echo "[SUCCESS] HF token copied to SLURM_TMPDIR"
else
    echo "[FAILED] HF token not found at /project/6084087/amomo/.cache/huggingface/token"
    # Try home directory
...
# " 2>/dev/null || echo "Model test skipped"
